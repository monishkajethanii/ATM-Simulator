...
public class Login1 extends JFrame implements ActionListener {
    ...
    Login1() {
        ...
        try {
            // Connecting java application with db using driver
            Class.forName("com.mysql.cj.jdbc.Driver");
            // Registering driver
            // Creating connection interface object
            ...
            // Creating Statement interface object
            Statement stm = conn.createStatement();
            // Writing queries using statement interface object
            stm.execute("INSERT INTO login1(username,password) values ('emailField','passwordField')");
            conn.close();
        } catch (Exception e) 
        {
            e.printStackTrace();
